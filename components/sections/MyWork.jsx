            ...
            <Div className="x-ideabox">
              <Div flex column gap={4}>
                ...
                >
                  ...
                  by TelkomGroup is a Website-based application for managing
                  idea collectors. You can see all of the ideas in idea feeds
                  and see the detail, you can also create your own idea, likes,
                  comment and join in other people ideas, and many more!.
                </Paragraph>
                <motion.div
                  ref={carousel}
            ...
            <Div className="x-irecruitment">
              <Div flex column gap={4}>
                ...
                >
                  ...
                  Website-based Modern Job Portal Application for Telkomsel, You
                  can see and apply on open vacancy, also you can see the
                  recruitment process in just one app!
                </Paragraph>
                <motion.div
                  ref={carousel2}
                  className="x-image-slide-container"
                ...
                >
                  ...
                  <span className="font-fredoka-bold">
                    world of modern hiring
                  </span>{" "}
                  with I-Recruitment - Telkomsel's all-in-one job portal where
                  you can explore open vacancies and seamlessly navigate the
                  entire recruitment process in a{" "}
            ...
            <Div className="x-amoebapage">
              <Div flex column gap={4}>
                ...
                >
                  ...
                  have interactive design and playful interface. Using Framer
                ...
                >
                  ...
                  Website-based Landing Page - a delightful blend of
                  interactivity and playful design, brought to life with
                  seamless animations powered by{" "}
